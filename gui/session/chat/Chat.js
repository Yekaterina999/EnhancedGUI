...
class Chat
{
	constructor(playerViewControl, cheats)
	{
		...
		Engine.SetGlobalHotkey("aiperspective.toggle", "Press", this.aimap.bind(this));
		Engine.SetGlobalHotkey("humanperspective.toggle", "Press", this.humanmap.bind(this));
	}
	...
	aimap(){
		...
		print("entering gaia mode")
	}
	humanmap(){
		print("reverting perspective")

		Engine.SetViewedPlayer(Engine.GetPlayerID());
